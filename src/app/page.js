        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <Link href="/sites" className="group">
            <div className="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-lg hover:border-blue-300 transition-all h-full flex flex-col">
              ...
              <h3 className="text-base font-bold text-gray-900 mb-1.5">Manage Projects</h3>
              <p className="text-xs text-gray-500 leading-relaxed flex-1">Create, edit, and manage reserve study projects. Add components, run calculations, and generate reports.</p>
              <p className="mt-3 text-xs font-semibold" style={{ color: '#1d398f' }}>View All Projects →</p>
            </div>
          </Link>

          {/* Component Health Monitor */}
          <Link href="/monitoring" className="group">
            <div className="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-lg hover:border-red-300 transition-all h-full flex flex-col">
              <div className="flex items-start justify-between mb-4">
              ...
              <h3 className="text-base font-bold text-gray-900 mb-1.5">Component Health</h3>
              <p className="text-xs text-gray-500 leading-relaxed flex-1">Monitor component lifecycles, track upcoming replacements, and view financial exposure across all sites.</p>
              <p className="mt-3 text-xs text-red-600 font-semibold">View Monitor →</p>
            </div>
          </Link>
              ...
              <div className="p-5">
                ...
                {isAdmin && (
                  <div className="flex gap-2 mt-4">
                    <Link href="/admin" className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors" style={{ backgroundColor: '#dbebff', color: '#1d398f' }}>
                    ...
                    {isSuperAdmin && (
                      <Link href="/super-admin" className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-semibold bg-red-50 text-red-700 hover:bg-red-100 transition-colors">
                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                        </svg>
                        Super Admin →
