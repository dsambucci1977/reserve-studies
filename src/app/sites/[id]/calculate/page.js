...
// v9.1: Adds byCategory data to saved results for Component Schedule Summary table
// - reserveFund.byCategory and pmFund.byCategory now included in saved projections
// - Used by results page to show per-category FFB, current reserve funds, funds needed
  ...
  const handleCalculate = async () => {
    ...
    try {
      ...
      const displayResults = {
        ...
        // Reserve Fund Results (v9.1: includes byCategory for Component Schedule Summary)
        reserveFund: {
        ...
        // PM Fund Results (empty when PM not required) (v9.1: includes byCategory)
