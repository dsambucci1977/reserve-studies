...
// v11: Fixes Summary Table Totals (Annual Funding now sums the column instead of showing Cash Flow rec)
// v10.1: Fixes "React is not defined" crash in Expenditure Schedule tab
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        ...
                        <tr className="bg-blue-100 font-bold border-t-2 border-blue-900">
                          ...
                          {/* FIX: Totals now dynamically sum up the rows instead of using Cash Flow rec */}
                          <td className="px-4 py-3 text-right text-sm text-blue-900">
                  ...
                  <table className="min-w-full divide-y divide-gray-200 text-xs">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {['Sitework', 'Building', 'Interior', 'Exterior', 'Electrical', 'Special', 'Mechanical'].map(category => {
                        ...
                        return (
                          // Uses React.Fragment which requires 'React' import
